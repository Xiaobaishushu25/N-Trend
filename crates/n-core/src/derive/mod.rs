...
mod tests {
    ...
    fn bar(datetime: &str, open: f64, high: f64, low: f64, close: f64, volume: f64, hold: f64) -> Kline {
        Kline {
    ...
    fn m15_bars() -> Vec<Kline> {
        ...
        vec![
            bar("2026-08-03 09:05:00", 100.0, 105.0, 99.0, 104.0, 100.0, 1000.0),
            bar("2026-08-03 09:10:00", 104.0, 106.0, 103.0, 105.0, 200.0, 1100.0),
            bar("2026-08-03 09:15:00", 105.0, 108.0, 104.0, 107.0, 150.0, 1200.0),
            bar("2026-08-03 09:20:00", 107.0, 107.5, 106.0, 106.5, 80.0, 1250.0),
            bar("2026-08-03 09:25:00", 106.5, 109.0, 106.0, 108.5, 120.0, 1300.0),
            bar("2026-08-03 09:30:00", 108.5, 110.0, 108.0, 109.5, 90.0, 1350.0),
        ]
    }
    ...
    fn session_gap_splits_same_calendar_bucket() {
        ...
        let bars = vec![
            bar("2026-08-03 09:10:00", 100.0, 102.0, 99.0, 101.0, 100.0, 1000.0),
            bar("2026-08-03 09:55:00", 101.0, 103.0, 100.0, 102.0, 200.0, 1100.0),
        ];
    ...
    fn daily_bucket_merges_night_into_next_day() {
        ...
        let bars = vec![
            bar("2026-08-03 21:05:00", 3000.0, 3020.0, 2990.0, 3010.0, 500.0, 10000.0),
            bar("2026-08-04 09:05:00", 3010.0, 3050.0, 3005.0, 3040.0, 700.0, 10500.0),
        ];
