...
- 综合评分满分 5.0，复盘页与形态卡片的“评分”列直接使用最终分数。
- 2026-08-14（版本 `1.1.0`）起，预警K线质量作为真实评分项计入总分：强趋势K、吞没、长影线比快速路径、多K累计覆盖、无预警约高 `0.3` 分，详见 `docs/2026-08-14 预警K线质量评分讨论.md`。
- 旧落盘记录不回填，历史 `score` 与 `dims` 保持不变；新扫描/新评估的信号才应用新评分逻辑。
