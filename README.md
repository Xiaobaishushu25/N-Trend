...
- 2026-08-14（版本 `1.1.0`）起，预警K线质量作为真实评分项计入总分：强反转（干净吞没）、长影线比多K累计覆盖、无预警约高 `0.3` 分，详见 `docs/2026-08-14 预警K线质量评分讨论.md`；2026-08-16 起快速路径预警已彻底删除，且强趋势K不再单独作为 `strong` 预警，详见 `docs/2026-08-16 删除快速路径.md` 与 `docs/2026-08-16 强反转合并与反向影线门槛.md`。
